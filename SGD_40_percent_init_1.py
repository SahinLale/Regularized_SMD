...
trainset = torch.load('./cifar_40_percent_corruption.pth')
...
#     scheduler.step()
    for i, (images, labels) in enumerate(trainloader):
        ...
        optimizer.zero_grad()
        loss.backward()
#         torch.nn.utils.clip_grad_value_(model.parameters(), 0.02)
        optimizer.step()
...
torch.save(model.state_dict(), './smd_40_percent_2norm_init_1.pth') 
